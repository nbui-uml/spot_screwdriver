...
class ArmClient:
    ...
    def arm_to_front(self):
        ...
        with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
            ...
            qw, qx, qy, qz = bosdyn.geometry.EulerZXY(math.radians(180), 0.0, math.radians(15)).to_quaternion() #whatever angle spot's cameras are looking down at
    ...
    def arm_to_pose(self, x, y, z, Z, X, Y, relative_frame=GRAV_ALIGNED_BODY_FRAME_NAME):
        ...
        with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
            ...
            # Rotation as a quaternion
            qw, qx, qy, qz = bosdyn.geometry.EulerZXY(math.radians(Z), math.radians(X), math.radians(Y)).to_quaternion()
